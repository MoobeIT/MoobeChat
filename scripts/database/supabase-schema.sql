-- Criação das tabelas para migração do Prisma para Supabase
-- Execute este script no SQL Editor do Supabase Dashboard

-- Primeiro, criar as tabelas básicas de usuários e workspaces
...
-- Aplicar triggers nas tabelas existentes também
...
-- Permitir todas as operações para usuários autenticados (simplificado)

-- Políticas para tabelas básicas
